   ...
   return(
      ...
      <div className='proj-header'>
         ...
         <div className='proj-hero-wrap'>
            <img src={'./assets/home/learn-this-instead.jpg'} alt="learn this instead final design" className='proj-hero'/>
         </div>
      </div>
      <main>
         ...
         <section id='tldr'>
            ...
            <a href='https://vimeo.com/735474155' target='blank' className='no-style-link'>
               <button>watch the presentation (11 min)<img src='./assets/search/arrow-right.svg' className='button-arrow' alt="right arrow" /></button>
            </a>
            <Link to="/learn-this-instead/#case-study"><a className='styled'>read more<img src='./assets/search/arrow-down-plain.svg' className='link-arrow' alt="down arrow" /></a></Link>
         </section>
         </ScrollAnimation>
         ...
         <section className='case-study-section' id='case-study'>
            ...
            <div className='right'>
               ...
               <div className='img-wrap'>
                  <img src='./assets/learn-this-instead/niche.png' alt="niche venn diagram" />
               </div>
            </div>
         </section>
         </ScrollAnimation>
         ...
         <section className='case-study-section'>
            ...
            <div className='right'>
               ...
               <div className='img-wrap'>
                  <img src='./assets/learn-this-instead/voice.png' className='sm-img' alt="voice descriptors" />
               </div>
               ...
               <div className='img-wrap'>
                  <img src='./assets/learn-this-instead/chapter-intros.png' className='sm-img' alt="chapter intro examples"/>
               </div>
               <br/><br/><h5>Visuals</h5>
               ...
               <div className='img-wrap'>
                  <img src='./assets/learn-this-instead/typography.png' className='sm-img' alt="typography choices" />
               </div>
               <div className='img-wrap back-to-back-img'>
                  <img src='./assets/learn-this-instead/colors.png' className='sm-img' alt="color palette" />
               </div>
            </div>
         </section>
         </ScrollAnimation>
         ...
         <section className='case-study-section'>
            ...
            <div className='right'>
               ...
               <div className='img-wrap'>
                  <img src='./assets/learn-this-instead/prompts1.png' className='sm-img' alt="list of prompts" />
               </div>
               <div className='img-wrap'>
                  <img src='./assets/learn-this-instead/prompts2.png' className='sm-img' alt="list of prompts" />
