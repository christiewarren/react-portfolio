   ...
   return(
      ...
      <div className='proj-header'>
         ...
         <div className='proj-hero-wrap'>
            <img src={'./assets/family-archive/family-archive.png'} alt="family archive mockups" className='proj-hero'/>
         </div>
      </div>
      <main>
         ...
         <section className='case-study-section'>
            ...
            <div className='right'>
               ...
               <div className='img-wrap'>
                  <img src='./assets/family-archive/moodboard.jpg' alt="moodboard" className='img-shadow'/>
               ...
               <div className='img-wrap'>
                  <img src='./assets/family-archive/color-palette.png' alt="color palette" className='img-shadow sm-img'/>
               ...
               <div className='img-wrap'>
                  <img src='./assets/family-archive/filters.png' alt="filters active state" className='sm-img img-shadow'/>
         ...
         <section className='case-study-section'>
            ...
            <div className='right'>
               ...
               >
                  <SwiperSlide>
                     <div className='img-wrap'>
                        <img src='./assets/family-archive/landing.jpg' alt="landing page mock" className='carousel-img-m img-shadow'/>
                        <small className='slide-caption'>Landing page—the grid will feature images fading in and out</small>
                     </div>
                  </SwiperSlide>
                  <SwiperSlide>
                     <div className='img-wrap'>
                        <img src='./assets/family-archive/photo-grid.jpg' alt="photo grid mock" className='carousel-img-m img-shadow'/>
                  ...
                  <SwiperSlide>
                     <div className='img-wrap'>
                        <img src='./assets/family-archive/filter-overlay.jpg' alt="filter overlay mock" className='carousel-img-m img-shadow'/>
                  ...
                  <SwiperSlide>
                     <div className='img-wrap'>
                        <img src='./assets/family-archive/photo-overlay.jpg' alt="photo overlay mock" className='carousel-img-m img-shadow'/>
                  ...
                  <SwiperSlide>
                     <div className='img-wrap'>
                        <img src='./assets/family-archive/bio.png' alt="bio page mock" className='carousel-img-m img-shadow'/>
