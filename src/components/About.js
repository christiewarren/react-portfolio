...
export default function Search(){
   ...
   return(
      ...
      <div className='about-header'>
         ...
         <h6><b>Hey, happy to have you here!</b><br/><br/>I'm a product designer currently working at <span className='highlight'>Alma and based in San Francisco.</span> I have a B.Des. in Graphic Design from Penn State, where I also grew my love for UX through the <a href='https://nittanyai.psu.edu/blog/nittany-ai-challenge-helps-design-christie-warrens-future/' className='styled xs' target={'_blank'}>NittanyAI Challenge.</a><br/><br/>My favorite type of work poses complex UX challenges and improves everyday life for users. I approach each project with ambition and curiosity, as well as a thoroughness that fosters smooth x-functional collaboration. I'd love to bring these qualities to a team that prioritizes people and process!
            ...
            <ScrollAnimation animateIn="animate__fadeInUp-New" duration={1} animateOnce={true} delay={500}>
               <div className='sm-proj-wrap love'>
                  <div className='about-me-thing'>
                     ...
                     <small className='sm-proj-description'>I do crosswords with friends on <a href='https://downforacross.com/'>Down for a Cross</a>, a genius innovation.</small>
                  </div>
               </div>
            </ScrollAnimation>
